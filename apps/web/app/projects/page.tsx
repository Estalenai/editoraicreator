...
export default function ProjectsPage() {
  ...
  return (
    <div className="page-shell projects-page">
      ...
      <section className="premium-card projects-list-section projects-flow-section surface-flow-region projects-flow-section-start" data-reveal data-reveal-delay="70">
      ...
      <section className="premium-card-soft projects-publish-section projects-flow-section surface-flow-region projects-flow-section-middle" data-reveal data-reveal-delay="110">
        <div className="section-header-ea">
      ...
      <section className="premium-card projects-handoff-section projects-flow-section surface-flow-region projects-flow-section-end" data-reveal data-reveal-delay="150">
        <div className="section-head">
          <div className="section-header-ea">
