...
const REVEAL_THRESHOLD = [0, 0.001, 0.008];
const REVEAL_ROOT_MARGIN = "0px 0px 42% 0px";
const REVEAL_ROOT_MARGIN_COMPACT = "0px 0px 54% 0px";
const REVEAL_DELAY_SCALE = 0.12;
const REVEAL_DELAY_SCALE_COMPACT = 0.08;
const REVEAL_DELAY_CAP_MS = 28;
const REVEAL_DELAY_CAP_MS_COMPACT = 14;
const REVEAL_IMMEDIATE_VIEWPORT_RATIO = 1.38;
