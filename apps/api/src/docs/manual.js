...
export const userManualPT = {
  ...
  sections: [
    ...
    {
      id: "credits",
      title: "Sistema de Creator Coins",
      summary: "Como funcionam Common, Pro e Ultra.",
      content: [
        { type: "p", text: "A plataforma usa Creator Coins em três tipos: common, pro e ultra. Isso separa custo de operações leves e avançadas." },
        {
          type: "list",
          items: [
        ...
        { type: "p", text: "Conversão de Creator Coins: qualquer combinação entre common, pro e ultra é permitida, exceto origem=destino. A taxa varia conforme seu plano." },
        ...
        { type: "p", text: "Creator Coins avulsas (Beta): use /api/coins/purchase/quote -> /create -> /confirm. Dependendo do ambiente, o fluxo pode ser mock." },
      ...
      keywords: ["creator-coins", "common", "pro", "ultra", "conversão", "purchase"],
    },
    {
      ...
      content: [
        ...
        { type: "list", items: ["Mínimo por tipo selecionado: 50.000 Creator Coins.", "Step padrão: múltiplos de 1.000 por tipo.", "O backend sempre recalcula preços e valida regras antes de criar o checkout."] },
        { type: "p", text: "Creator Coins são liberadas somente após confirmação de pagamento no webhook Stripe (não no return_url)." },
    ...
    },
    {
      ...
      content: [
        ...
        { type: "faq", q: "Como economizar Creator Coins?", a: "Use qualidade menor no rascunho e aumente só na versão final." },
        ...
        { type: "faq", q: "Como comprar Creator Coins?", a: "Use quote/create/confirm em /api/coins/purchase/*." },
        { type: "faq", q: "Posso converter Creator Coins?", a: "Sim. No Beta, você pode converter entre common, pro e ultra (exceto origem=destino), com taxa por plano." },
