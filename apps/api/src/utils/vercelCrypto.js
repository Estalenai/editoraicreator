...
function resolveSecret() {
  const raw =
    String(process.env.VERCEL_INTEGRATION_SECRET || "").trim() ||
...
export function encryptVercelToken(token) {
...
export function decryptVercelToken(payload) {
  if (!payload || typeof payload !== "object") {
    throw new Error("vercel_token_payload_invalid");
  }
