const PUBLISH_RECONCILIATION_VERSION = "editor-ai-creator.publish-reconciliation.v1";
...
function isManualResolutionCandidate({ delivery, githubSource, vercelSource }) {
...
function buildStatePayload({
  ...
  return {
    version: PUBLISH_RECONCILIATION_VERSION,
...
export function buildPublishReconciliation({
  ...
  const lastConfirmedState = externalConfirmedTimestamps.publishedAt
    ? "published"
