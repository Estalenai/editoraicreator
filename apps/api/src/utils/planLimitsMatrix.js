...
function noCodePolicy({
  ...
  baseCreditType = "common",
  integrationStatus = "prepared",
  advancedExecutionEnabled = false,
  advancedExecutionStatus = "disabled",
  advancedCreditType = null,
  ...
  return {
    ...
    base_experience_enabled: enabled === true,
    base_experience_status: String(baseExperienceStatus || "disabled").trim().toLowerCase() || "disabled",
    base_credit_type: String(baseCreditType || "common").trim().toLowerCase() || "common",
    integration_status: String(integrationStatus || "prepared").trim().toLowerCase() || "prepared",
    advanced_execution_enabled: advancedExecutionEnabled === true,
    advanced_execution_status:
      String(advancedExecutionStatus || "disabled").trim().toLowerCase() || "disabled",
    advanced_credit_type:
      advancedCreditType == null ? null : String(advancedCreditType).trim().toLowerCase() || null,
...
const PLAN_LIMITS_MATRIX = {
  FREE: {
    ...
    no_code: noCodePolicy({
      ...
      baseExperienceStatus: "limited",
      baseCreditType: "common",
      currentRuntimeFeature: "text_generate",
      manualModeAllowed: false,
      manualModeLevel: "none",
      notes: [
        "Creator No Code permanece em camada base e exploratoria neste plano, sem patch runtime nem providers de codigo avancado.",
        "Codex e Claude Code ficam apenas preparados internamente e nao entram como providers executaveis neste tier.",
      ],
    }),
    honesty_notes: [
  ...
  EDITOR_FREE: {
    ...
    no_code: noCodePolicy({
      ...
      manualModeLevel: "limited",
      notes: [
        "Iniciante recebe apenas a experiencia base do Creator No Code para blueprint e estruturacao inicial.",
        "Codex e Claude Code seguem bloqueados neste tier e continuam apenas preparados internamente.",
      ],
    }),
    honesty_notes: [
  ...
  EDITOR_PRO: {
    ...
    no_code: noCodePolicy({
      ...
      manualModeLevel: "limited",
      notes: [
        "Editor Pro recebe a experiencia base do Creator No Code para blueprint e planejamento inicial.",
        "Codex e Claude Code seguem preparados, nao ativos, e continuam restritos a Creator Pro em diante.",
      ],
    }),
    honesty_notes: [
  ...
  EDITOR_ULTRA: {
    ...
    no_code: noCodePolicy({
      ...
      baseCreditType: "common",
      integrationStatus: "prepared",
      advancedExecutionEnabled: true,
      advancedExecutionStatus: "prepared",
      advancedCreditType: "ultra",
      currentRuntimeFeature: "text_generate",
      manualModeAllowed: true,
